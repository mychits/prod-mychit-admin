...
const EnrollmentRequest = () => {
  ...
  const [currentEnrollmentRequest, setCurrentEnrollmentRequest] =
    useState(null);
  const [currentUpdateEnrollmentRequest, setCurrentUpdateEnrollmentRequest] = useState(null);
    ...
    const fetchEnrollmentRequests = async () => {
      try {
        ...
        const formattedData = response.data.map((data, index) => ({
          ...
          customer_panno: data?.customer_panno,
                  ...
                  items: [
                    {
                      ...
                      label: (
                        <div
                          ...
                          onClick={() =>{ handleUpdateModalOpen(data?._id)}}
                        >
                          Edit
                        </div>
                      ),
...
fetchGroupData()
  ...
  const handleUpdateModalOpen = async (enrollmentRequestId) => {
    try {
      const response = await api.get(`/enrollment-request/get-enrollment-request-data-by-id/${enrollmentRequestId}`);
            ...
            <form className="space-y-6" onSubmit={handleUpdate} noValidate>
              ...
              <div>
                ...
                <input
                  ...
                  value={ updateFormData?.customer_dateofbirth
              ...
              <div>
                ...
                <input
                  ...
                  value={ updateFormData?.customer_nominee_dateofbirth
            ...
            <option value="Other">Other</option>
              ...
              <div>
                ...
                <input
                  type="number"
                  name="customer_panno"
                  value={updateFormData?.customer_panno}
                  onChange={handleInputChange}
                  id="pan"
              ...
              <div>
                ...
                <input
                 ...
                 // value= {enrollData?.customer_aadhar_frontphoto}
                  ...
                  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2.5"
                />
                 <img src={updateFormData?.customer_aadhar_frontphoto} alt="Aadhar Front" className="w-56 mx-2 my-4 h-56"/>
              </div>
              ...
              <div>
                ...
                <input
                 ...
                 // value= {enrollData?.customer_aadhar_frontphoto}
                  ...
                  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2.5"
                />
                 <img src={updateFormData?.customer_aadhar_backphoto} alt="Aadhar Back" className="w-56 mx-2 my-4 h-56" />
              </div>
              ...
              <div>
                ...
                <input
                 ...
                 // value= {enrollData?.customer_pan_frontphoto}
                  ...
                  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2.5"
                />
                 <img src={updateFormData?.customer_pan_frontphoto} alt="Pan Front" className="w-56 mx-2 my-4 h-56"/>
              </div>
              ...
              <div>
                ...
                <input
                 ...
                 // value= {enrollData?.customer_pan_backphoto}
                  ...
                  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2.5"
                />
                 <img src={updateFormData?.customer_pan_backphoto} alt="Pan Back" className="w-56 mx-2 my-4 h-56" />
              </div>
              ...
              <div>
                ...
                <input
                 ...
                 // value= {enrollData?.customer_profilephoto}
                  ...
                  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-full p-2.5"
                />
               <img src={updateFormData?.customer_profilephoto} alt="Profile Photo" className="w-56 mx-2 my-4 h-56"/>
              </div>
                ...
                <div>
                  ...
                  >
                    ...
                    <span className="text-primary font-bold">
                      {currentEnrollmentRequest?.customer_name}
                    </span>{" "}
                    to confirm deletion.
                  </label>
                  <input
