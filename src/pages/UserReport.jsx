            ...
            try {
                ...
                if (response.data && response.data.length > 0) {
                    ...
                    const formattedData = response.data.map((group, index) => {
                        ...
                        const groupInstall = parseInt(group?.enrollment?.group?.group_install) || 0;
                        ...
                        const firstDividentHead = group?.firstAuction?.firstDividentHead || 0;
            ...
            try {
                ...
                if (response.data && response.data.length > 0) {
                    ...
                    const formattedData = response.data.map((group, index) => ({
                        ...
                        ticket: group.ticket,
                        amount_to_be_paid: parseInt(group.group.group_install) + group.totalToBePaidAmount,
                        amount_paid: group.totalPaidAmount,
                        amount_balance: (parseInt(group.group.group_install) + group.totalToBePaidAmount) - group.totalPaidAmount
                    }));
                                                        ...
                                                        detailsLoading ? (
                                                            ...
                                                            <div className="mt-10">
                                                                ...
                                                                <div className="flex gap-4 mt-5">
                                                                    <div className="flex flex-col flex-1">
                                                                        <label className="mb-1 text-sm font-medium text-gray-700">Adhaar Number</label>
                                                                        <input
                                                                            type="text"
                                                                    ...
                                                                    <div className="flex flex-col flex-1">
                                                                        <label className="mb-1 text-sm font-medium text-gray-700">Pan Number</label>
                                                                        <input
                                                                            type="text"
                                                                ...
                                                                <div className="mt-10">
                                                                    <h3 className="text-lg font-medium mb-4">Enrolled Groups</h3>
                                                                ...
                                                                <div className="flex gap-4 mt-5">
                                                                    <div className="flex flex-col flex-1">
                                                                        <label className="mb-1 text-sm font-medium text-gray-700">Total Amount to be Paid</label>
                                                                        <input
                                                                            type="text"
                                                                            placeholder="-"
                                                                            value={TotalToBepaid}
                                                                    ...
                                                                    <div className="flex flex-col flex-1">
                                                                        <label className="mb-1 text-sm font-medium text-gray-700">Total Profit</label>
                                                                        <input
                                                                            type="text"
                                                                            placeholder="-"
                                                                            value={Totalprofit}
                                                                    ...
                                                                    <div className="flex flex-col flex-1">
                                                                        <label className="mb-1 text-sm font-medium text-gray-700">Total Net To be Paid</label>
                                                                        <input
                                                                            type="text"
                                                                            placeholder="-"
                                                                    ...
                                                                    <div className="flex flex-col flex-1">
                                                                        <label className="mb-1 text-sm font-medium text-gray-700">Total Amount Paid</label>
                                                                        <input
                                                                            type="text"
                                                                            placeholder="-"
                                                                            value={Totalpaid}
                                                                    ...
                                                                    <div className="flex flex-col flex-1">
                                                                        <label className="mb-1 text-sm font-medium text-gray-700">Total Balance</label>
                                                                        <input
                                                                            type="text"
                                                                            placeholder="-"
