            ...
            <div className="mt-6 mb-8">
              <div className="flex justify-between items-center w-full">
                <div className="flex flex-col">
                  <div className="flex">
                    <IoIosWarning  size="30" className="m-2 text-yellow-600" />
                ...
                <button
                  ...
                  className="relative ml-4 bg-yellow-600 text-white px-4 py-2 rounded shadow-md hover:bg-yellow-700 transition duration-200"
                >
