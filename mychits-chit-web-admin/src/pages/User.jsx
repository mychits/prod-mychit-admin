...
const [admin,setAdmin]= useState({});
  useEffect(() => {
    ...
    console.info(storedUser,"stored-user")
    if (storedUser) {
  ...
  const handleUpdateModalOpen = async (userId) => {
    try {
      ...
      setUpdateFormData({
        ...
        selected_plan: response?.data?.selected_plan,
        ...
        aadhar_frontphoto: response?.data?.aadhar_frontphoto, // file uploads
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      // if (isValid) {
      await api.put(`/user/update-user/${currentUpdateUser?._id}`, {
        ...updateFormData,
        selected_plan: selectedGroup?._id,
      });
